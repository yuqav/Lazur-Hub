local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/yuqav/Lazur-Hub/refs/heads/main/gui.lua"))()

local Window = Library.CreateLib("Lazur Hub - Go Fishing", "Default")
